...
if __name__ == "__main__":
    ...
    df_data = df_data[(df_data["Date"] >= DATE_START) & (df_data["Date"] <= DATE_END)]
    ...
    for row in df_data.iterrows():
        ...
        for col_ind, col_inf in enumerate(xl_columns):
            ...
            if col_inf["is_hyperlink"]:
                if pandas.notna(row_data[col_inf["value_column"]]) and row_data[col_inf["value_column"]] != "":
                    cell.value = "=HYPERLINK(\"{0}\", \"X\")".format(row_data[col_inf["value_column"]])
